...
def test_positive_login():
    ...
    email.click()
    email.send_keys('ihelbatimnotkill@yandex.ru') # введи тут email своего тестового аккаунта на stage окружении
    ...
    password.click()
    password.send_keys('82001200oO') # введи тут пароль своего тестового аккаунта на stage окружении
    ...
    assert trainer_id.text.replace('\n', ': ') == 'ID: 2108', 'Unexpected ID trainer' # введи тут ID своего тренера